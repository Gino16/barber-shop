 ...
 * <p>
 * Usa @ServerResponseFilter (quarkus-rest reactivo) en lugar de ContainerResponseFilter (JAX-RS
 * clásico) para que el Span activo sea accesible correctamente en el contexto reactivo.
 */
